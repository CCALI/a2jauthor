...
var a2jviewer={
	layout:function(div,curstep,steps,question,learnmore)
	{
		...
		$('.A2JViewer form.question').html(question);
		$('.A2JViewer form.learnmore').html(learnmore);
	...
	{	
		var steps=['<img style="position:absolute; left:0; bottom: 0; width: 935px; height: 574px;" src="'+IMG+'step1.png" width="804" height="531" /><img src="'+IMG+'step_courthouse.png" width="734" height="255" style="position:absolute; left: 249px; top: -2px;"  /><img class="circle1" style="position:absolute; left:  218px; top: 366px;" src="'+IMG+'step_circle.png" width="370" height="92" /> <img style="position:absolute; left: 389px; top: 274px;" src="'+IMG+'blank_guide2front.png" width="175" height="165" /> <img style="position:absolute; left: 478px; top: 421px;" src="'+IMG+'step_sign.png" width="422" height="120" /><div class="question bubble" style="position:absolute; left:57px; top: 140px; width: 285px; "><form class="question"><p>Question text appears here</p><div class="buttonlist"><button>Yes</button><button>No</button></div></form></div><div class="stepnumber step1" style="position:absolute; left:498px; top: 445px; width: 55px;">12</div><div class="steptext step1" style="position:absolute; left:561px; top: 429px; width: 234px;" class="question">Congratulations. You have completed this interview!</div><img style="position:absolute; left: 363px; top: 274px; width: 36px; height: 22px;" src="'+IMG+'guide_bubble_tip.png" width="59" height="42" />',
					  
					  
		'<img style="position:absolute; left:0; bottom: 0; width: 934px; height: 591px;" src="'+IMG+'step7.png" width="804" height="531" /><img src="'+IMG+'step_courthouse.png" width="373" height="88" style="position:absolute; left: 411px; top: 42px; width: 268px; height: 47px;"  /><img style="position:absolute; left:  274px; top: 210px; width: 311px; height: 62px;" src="'+IMG+'step_circle.png" class="circle2" width="477" height="118" /><img style="position:absolute; left:  160px; top: 368px;" src="'+IMG+'step_circle.png" class="circle1" width="477" height="118" /><img style="position:absolute; left: 389px; top: 278px;" src="'+IMG+'blank_guide2front.png" width="175" height="165" /> <img style="position:absolute; left: 551px; top: 413px;" src="'+IMG+'step_sign.png" width="422" height="120" /> <img style="position:absolute; left:  517px; top: 248px; width: 246px; height: 59px;" src="'+IMG+'step_sign.png" width="422" height="120" />	<div class="stepnumber step2" style="position:absolute; left: 530px; top: 260px; width: 24px; height: 17px;">2</div><div class="steptext step2" style="position:absolute; left: 562px; top: 260px; width: 131px; height: 21px;">Your information</div><div class="stepnumber step1" style="position:absolute; left:572px; top: 440px; width: 55px;">1</div><div class="steptext step1" style="position:absolute; left:633px; top: 433px; width: 234px; height: 52px;">Welcome!</div><div class="question bubble" style="position:absolute; left:57px; top: 140px; width: 285px; ">		<form class="question">			<p>Question text appears here</p>			<div class="buttonlist"><button>Yes</button><button>No</button></div></form></div><img style="position:absolute; left: 362px; top: 279px; width: 36px; height: 22px;" src="'+IMG+'guide_bubble_tip.png" width="59" height="42" /> '];
		
		var shared = '<div class="learnmore bubble" style="position:absolute; left:604px; top: 93px; width: 285px;"><form class="learnmore"><p>Learn more text appears here.</p><div class="buttonlist"><button>Close</button></div></form></div>';
