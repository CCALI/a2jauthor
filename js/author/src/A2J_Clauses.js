...
{	// 2015-03-27 Clause editor
	...
	$('#clauseusage').button({label:'Quick Find',icons:{primary:'ui-icon-link'}}).click(function()
	{	// 2015-03-27 List all references to this clause.
	...
	$('#clause-edit-form').data(  clause ).dialog({
		autoOpen:true,
			...
			{text:'Delete', click:function(){
				...
				dialogConfirmYesNo({title:'Delete clause '+name,message:'Delete this clause?',name:name,Yes:
				/*** @this {{name}} */
				function(){
