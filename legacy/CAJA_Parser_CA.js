...
function parseXML_CA_to_CAJA (BOOK) {	// Parse CALI Author into CAJA
  ...
  BOOK.find('BOOK > PAGE').each(function () {
    ...
    if ($mapper) {	// XML: <MAPPER ID="47" BOUNDS="1198,360,109"><BRANCH KIND="14" NAME="True" DEST="47" BOUNDS="1196,408,30"/></MAPPER>
    ...
    if (!(page.type === 'Topics' && page.name !== 'Contents')) {	// skip placeholder pages
