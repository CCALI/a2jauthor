...
function exportXML_CAJA_from_CAJA (guide) {	// Convert Guide structure into XML
  ...
  JSON.GUIDE.INFO.useMobileUI = guide.useMobileUI
  ...
  JSON.GUIDE.INFO.publishedVersion = guide.publishedVersion
...
{	// Parse parseCAJA
  ...
  guide.useMobileUI =	textToBool(INFO.children('USEMOBILEUI').text(), false)
  ...
  guide.publishedVersion = makestr(INFO.children('PUBLISHEDVERSION').text())
