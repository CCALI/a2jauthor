...
function cleanText (text) {
  console.log('passed to cleanText', text)
...
var TextStatistics = function TextStatistics (text) {
  ...
  console.log('clean text', this.text)
}
...
TextStatistics.prototype.wordCount = function (text) {
  text = text ? cleanText(text) : this.text
  console.log('word count', text.match(/\S+/g).length || 1)
...
TextStatistics.prototype.syllableCount = function (word) {
  ...
  //   console.log('new TextStatistics instance')
